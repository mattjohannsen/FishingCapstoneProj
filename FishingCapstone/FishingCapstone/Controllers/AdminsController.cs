...
namespace FishingCapstone.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AdminId,IdentityUserId,AdminFirst,AdminLast")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdminId,IdentityUserId,AdminFirst,AdminLast")] Admin admin)
        {
            if (id != admin.AdminId)
            {
                return NotFound();
